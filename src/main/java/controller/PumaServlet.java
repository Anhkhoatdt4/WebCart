...
/**
 * Servlet implementation class PumaServlet
 */
@WebServlet("/Puma")
public class PumaServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Product> allProducts = productDAO.getListByCategoryID(3);
...
//        System.out.println("num" + totalPages);
        ...
        request.getRequestDispatcher("Puma.jsp").forward(request, response);
	}
