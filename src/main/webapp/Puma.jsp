        ...
        <div class="main" id="Home">
            <div class="main_content">
                ...
                <div class="main_image">
                    <img src="https://myshoes.vn/image/catalog/2023/puma/giay-puma-RBD-game-low-nam-trang-xanh-02.jpg">
                </div>
            </div>
            ...
            <div class="about_main">
                <div class="about_image">
                    ...
                    <div class="image_contaner">
                        <img src="https://myshoes.vn/image/catalog/2023/puma/pu01/giay-puma-slipstream-archive-remastered-nam-trang-xanh-la-04.jpg" id="imagebox">
                    </div>

                </div>

                <div class="about_text">
                        <h1>Giới Thiệu Về Puma</h1>
                        <p>
                            Puma, một trong những thương hiệu thể thao hàng đầu trên toàn thế giới, đã có một lịch sử đầy tính sáng tạo và tiên phong. Công ty được thành lập vào năm 1948 bởi Rudolf Dassler, một trong những người sáng lập của Adidas, với tên gọi ban đầu là "Ruda", trước khi chuyển thành Puma vào năm 1949.

							Puma nổi tiếng với việc sản xuất các sản phẩm thể thao chất lượng và phong cách, từ giày thể thao đến quần áo và phụ kiện. Với sự kết hợp của công nghệ tiên tiến và thiết kế độc đáo, Puma không chỉ là một thương hiệu thể thao mà còn là biểu tượng của phong cách và sự đẳng cấp.
							Với khẩu hiệu "Forever Faster", Puma khuyến khích mọi người vươn lên và vượt qua giới hạn của họ, thúc đẩy sự sáng tạo và nỗ lực để đạt được mục tiêu và ước mơ của mình.
