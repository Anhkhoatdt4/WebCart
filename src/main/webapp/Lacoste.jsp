    ...
    <c:choose>
        ...
        <div class="main" id="Home">
            <div class="main_content">
                <div class="main_text">
                    <h1>Lacoste<br><span>Collection</span></h1>
                    <p>
                ...
                <div class="main_image">
                    <img src="https://myshoes.vn/image/catalog/2023/lacoste/022/giay-lacoste-l001-123-trang-nau-06.jpg">
                </div>
            </div>
      ...
      <div class="pagination" style=" border-radius:10px 20px ; margin-top: 15px; margin-left: 70px">
        <c:if test="${num > 1}">
            <c:forEach var="pageNumber" begin="1" end="${num}">
                <c:url var="pageURL" value="/Lacoste">
            ...
            <div class="about_main">
                <div class="about_image">
                    ...
                    <div class="image_contaner">
                        <img src="https://myshoes.vn/image/catalog/2023/lacoste/ls01/giay-lacoste-l001-223-trang-xanh-02.jpg" id="imagebox">
                    </div>

                </div>

                <div class="about_text">
                        <h1>Giới Thiệu Về Lacoste</h1>
                        <p>
                            
							Lacoste, một thương hiệu thời trang danh tiếng, được thành lập vào năm 1933 bởi tay vợt người Pháp René Lacoste và André Gillier. Với nguồn cảm hứng từ thế giới quần vợt, René Lacoste đã sáng tạo ra một biểu tượng thời trang cổ điển và sang trọng.
							
							Lacoste nổi tiếng với việc sản xuất các sản phẩm thời trang cao cấp, từ quần áo đến phụ kiện, với thiết kế tối giản và đẳng cấp. Biểu tượng cá sấu nổi tiếng của Lacoste là biểu tượng của phong cách và thể thao, đồng thời là biểu tượng của sự sang trọng và đẳng cấp.
							Với khẩu hiệu "Life is a beautiful sport", Lacoste khuyến khích mọi người sống cuộc sống với đầy đủ niềm vui và năng động. Thương hiệu này thúc đẩy tinh thần thể thao và sự tự tin, khuyến khích mọi người thể hiện bản thân và phong cách cá nhân của họ thông qua thời trang.
                        </p>
                    </div>
                </div>
