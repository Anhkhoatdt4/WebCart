            ...
            <div class="main">
                ...
                <div class="sumofmoney" style="display: flex;">
                    <ul style = "margin-left: 30px; ">
                        ...
                        <li style ="list-style-type: none; font-size: 14px;">$ ${tongtien}</li>
                    </ul>
                    <ul>
                        <li style ="list-style-type: none; margin-left: 40px; margin-top: 28px; font-size:40px;color: #ff8b07;"><a><i class="fa-solid fa-money-bill-1"></i></a></li>
                    </ul>
                </div>
                <div class="outofstock" style="display: flex;">
                    <ul style = "margin-left: 30px; ">
                        <li style ="list-style-type: none; margin-top: 25px; margin-bottom: 10px; font-weight: bold; font-size: 18px;color: red;">Hết hàng</li>
                        <li style ="list-style-type: none; font-size: 14px;">2 sản phẩm</li>
                    </ul>
                    <ul>
                        <li style ="list-style-type: none; margin-left: 80px; margin-top: 28px; font-size:40px;color: #de2222; "><a><i class="fa-solid fa-triangle-exclamation"></i></a></li>
                    </ul>
                </div>
                <div class="topsales" style="height: 330px;">
                 ...
                 <div class="stock" style="height: 510px;">
                    <ul style = "display: flex; margin-left: 30px; ">
                        <li style =" list-style-type: none; margin-top: 20px; font-weight: bold; font-size: 20px;">SẢN PHẨM BÁN CHẠY TRONG THÁNG</li>
                    </ul>
                    <br>
                    <hr>
                    <br>
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>${product.pId}</td>
                              <td>${product.pname}</td>
                              <td style="width: 200px;"> <img alt="" src="${product.pimage}" style="width: 55%; height: 48%;"> </td>
                ...
                <div class="sumoforder2" style="height: 520px; margin-left: 20px;">
                    <ul style = "display: flex; margin-left: 30px; ">
                        <li style ="list-style-type: none; margin-top: 20px; font-weight: bold; font-size: 20px;">TỔNG ĐƠN HÀNG</li>
                    </ul>
                    <br>
                    <hr>
                    <br>
                ...
                <div class="stock" style=" margin-left: 0px ; height: 402px;
    border-radius: 5px;
    margin-top: 47px;">
                    <ul style = "display: flex; margin-left: 30px; ">
                        <li style ="list-style-type: none; margin-top: 20px; font-weight: bold; font-size: 20px;">SẢN PHẨM HẾT HÀNG</li>
                    </ul>
                    <br>
                    <hr>
                    <br>
                        ...
                        <thead>
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td style="width: 200px;"><img style ="    height: 100px;
   									 width: 127px;"src="https://myshoes.vn/image/catalog/2023/nike/nike02/giay-air-jordan-1-low-nam-xanh-den-01.jpg"></td>
							  <td>0</td>
							  <td>Hết hàng</td>
							  <td>$ 200</td>
                            </tr>
                            <tr>
                              ...
                              <td style="width: 200px;"><img style ="    height: 100px;
   									 width: 127px;"src="https://product.hstatic.net/200000581855/product/giay_nike_dunk_low_retro_white_black_panda_dd1391-1007_c9bb92bc44374458a4d6d896a0350d83_master.png"></td>
							  <td>0</td>
							  <td>Hết hàng</td>
							  <td>$ 300</td>
                            </tr>
                ...
                <div class="merge" style="margin-top: 40px; padding-bottom: 60px;">
	                <div class="chart" style="margin-left: 4px;">
	                    <ul style="display: flex; margin-left: 30px;">
	                        <li style="list-style-type: none; margin-top: 20px; font-weight: bold; font-size: 20px;">DỮ LIỆU HÀNG THÁNG</li>
	                    </ul>
	                    <br>
	                    <hr>
	                    <br>
                ...
                <script src="script/script.js"></script>
	                ...
	                <div class="chart2">
	                    <ul style="display: flex; margin-left: 30px;">
	                        <li style="list-style-type: none; margin-top: 20px; font-weight: bold; font-size: 20px;">THỐNG KÊ DOANH SỐ</li>
	                    </ul>
	                    <br>
	                    <hr>
	                    <br>
