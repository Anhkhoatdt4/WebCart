        ...
        <div class="main" id="Home">
            <div class="main_content">
                ...
                <div class="main_image">
                    <img src="https://myshoes.vn/image/catalog/2023/adidas/adi2/giay-adidas-solar-glide-5-nam-vang-cam-01.jpg">
                </div>
            </div>
      ...
      <div class="pagination" style=" border-radius:10px 20px ; margin-top: 15px; margin-left: 70px">
        <c:if test="${num > 1}">
            <c:forEach var="pageNumber" begin="1" end="${num}">
                <c:url var="pageURL" value="/Adidas">
            ...
            <div class="about_main">
                <div class="about_image">
                    ...
                    <div class="image_contaner">
                        <img src="https://myshoes.vn/image/catalog/2023/adidas/adi2/giay-adidas-superstar-nam-%20xanh-vang-03.jpg" id="imagebox">
                    </div>

                </div>

                <div class="about_text">
                        <h1>Giới Thiệu Về Adidas</h1>
                        <p>
                            Adidas là một trong những thương hiệu thể thao hàng đầu trên thế giới, được thành lập vào năm 1949 bởi Adolf Dassler. Với một lịch sử lâu dài và uy tín, Adidas đã trở thành biểu tượng của sự đổi mới, chất lượng và phong cách trong ngành công nghiệp thể thao.

							Công ty nổi tiếng với việc sản xuất giày thể thao, quần áo và phụ kiện thể thao, Adidas không chỉ mang lại các sản phẩm chất lượng cao và thiết kế sáng tạo, mà còn tạo ra những ảnh hưởng sâu rộng trong cộng đồng thể thao và giới trẻ toàn cầu.

							Với khẩu hiệu "Impossible is Nothing", Adidas tôn vinh sự quyết tâm và ý chí phi thường. Họ khuyến khích mọi người vượt qua những thách thức và khám phá tiềm năng của bản thân, đồng thời thúc đẩy sự đoàn kết và sáng tạo trong cộng đồng.
                        </p>
                    </div>
                </div>
