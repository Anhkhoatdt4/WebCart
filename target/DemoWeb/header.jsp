...
<body>
    ...
    <section>
        <nav>
			...
			<div class="banner" style="width: 23%; ">
                <ul class="ul-header">
                    <li><a href="#">Home</a></li>
                    <li><a href="#Nike" class="a_header">Products</a>
                        <div class="banner_header" style="right: 135px">
                            <ul>
                                ...
                                <li><a href="#Services">Adidas</a></li>
                                <li><a href="#About">Puma</a></li>
                                <li><a href="#Services">Lacoste</a></li>
                            </ul>
                        </div>
                    </li>
            ...
            <div class="icons">
                ...
                <a href="login.jsp" style="text-decoration: none; color :black"><i class="fa-solid fa-user"></i> Tài khoản</a> 
            </div>
